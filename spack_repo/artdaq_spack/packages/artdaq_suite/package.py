...
class ArtdaqSuite(BundlePackage):
    ...
    with when("@v4_04_01"):
        ...
        # External Dependencies not in art-suite
        depends_on("swig@4:")
        depends_on("xmlrpc-c@1: +curl")
        depends_on("curl@7:")
        depends_on("qt@5: +gui+shared")
        depends_on("librdkafka@2:")
        depends_on("epics-base@7:", when="+epics")
        depends_on("mongo-cxx-driver@3: +dots_in_keys", when="+db")
    with when("@v4_04_00"):
        depends_on("trace@v3_20_00")
        depends_on("artdaq-core@v4_03_00")
        depends_on("artdaq-utilities@v2_01_01")
